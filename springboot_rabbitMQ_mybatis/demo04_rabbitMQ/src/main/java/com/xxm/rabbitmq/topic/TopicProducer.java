package com.xxm.rabbitmq.topic;
 ...
 * @CreateDate: 2019-11-13 10:52:08 周三
 * @LastModifyDate:
 * @LastModifyBy:
 * @Version: V1.0
 */
public class TopicProducer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //消息-item.insert
        String message_insert = "发布订阅模式-Topic-item.insert:欢迎来到xxm！";
        /**
         * 消息发送
        ...
        //消息-item.update
        String message_update = "发布订阅模式-Topic-item.update:欢迎来到xxm！";
        channel.basicPublish("topic_exchange","item.update",null,message_update.getBytes());

        //消息-item.delete
        String message_delete = "发布订阅模式-Topic-item.delete:欢迎来到xxm！";
